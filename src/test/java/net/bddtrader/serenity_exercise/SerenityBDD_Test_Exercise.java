...
@RunWith(SerenityRunner.class) // Adding the Serenity Reporting features on top of the Rest Assured Examples -we
//just need to include the SerenityRunner.class - to run the test cases as part of Serenity Wrapper and generate the report.
public class SerenityBDD_Test_Exercise {
